...
' );
        ...
        wp_localize_script( 'flora-public', 'floraShop', array(
            ...
            'i18n'    => array(
                'added'         => Flora_Helpers::ui( __( 'Ajouté au panier !', 'flora-shop' ), 'تمت الإضافة إلى السلة!' ),
                'updated'       => Flora_Helpers::ui( __( 'Panier mis à jour.', 'flora-shop' ), 'تم تحديث السلة.' ),
                'removed'       => Flora_Helpers::ui( __( 'Article retiré.', 'flora-shop' ), 'تمت إزالة المنتج.' ),
                'error'         => Flora_Helpers::ui( __( 'Une erreur est survenue.', 'flora-shop' ), 'حدث خطأ ما.' ),
                'confirm'       => Flora_Helpers::ui( __( 'Voulez-vous vraiment vider le panier ?', 'flora-shop' ), 'هل تريد حقاً إفراغ السلة؟' ),
                'processing'    => Flora_Helpers::ui( __( 'Traitement en cours...', 'flora-shop' ), 'جارٍ المعالجة...' ),
                'added_free'    => Flora_Helpers::ui( __( 'Article offert ajouté', 'flora-shop' ), 'تمت إضافة المنتج المجاني' ),
                'empty'         => Flora_Helpers::ui( __( 'Votre panier est vide.', 'flora-shop' ), 'سلّتك فارغة.' ),
                'cart_title'    => Flora_Helpers::ui( __( 'Mon panier', 'flora-shop' ), 'سلّتي' ),
                'close'         => Flora_Helpers::ui( __( 'Fermer', 'flora-shop' ), 'إغلاق' ),
